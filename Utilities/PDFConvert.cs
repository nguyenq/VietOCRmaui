    ...
    public class PDFConvert
    {
        ...
        private bool Convert(string inputFile, string outputFile, bool throwException, string options)
        {
            ...
            if (string.IsNullOrEmpty(inputFile))
            {
                ...
                {
                    Application.Current.MainPage.DisplayAlert("Alert", "The inputfile is missing.", "OK");
            ...
            if (!System.IO.File.Exists(inputFile))
            {
                ...
                else
                {
                    ...
                    Application.Current.MainPage.DisplayAlert("Alert", string.Format("The file '{0}' doesn't exist.", inputFile), "OK");
                    return false;
                }
            }
            if (string.IsNullOrEmpty(_sDeviceFormat))
            {
                ...
                {
                    Application.Current.MainPage.DisplayAlert("Alert", "You didn't provide a device for the conversion.", "OK");
            ...
            try
            {
                ...
                if (intReturn < 0)
                {
                    ...
                    {
                        Application.Current.MainPage.DisplayAlert("Alert", GSDLL_INSTANCE, "OK");
            ...
            {//in this case the dll we r using isn't the dll we expect
                ...
                {
                    Application.Current.MainPage.DisplayAlert("Alert", GSDLL_NOT_FOUND, "OK");
